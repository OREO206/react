...
import Properties from './component_manager/Properties';
import SignInContainer from './component_manager/example/SignInContainer';
import ConditionalRendering from './component_manager/ConditionalRendering';
import ListRendering from './component_manager/ListRendering';
...
// class로 컴포넌트를 작성
// 반드시 첫글자는 대문자로 작성
// reat 패키지에 있는 Component 클래스를 상속하여 구현
// render() 함수의 반환값으로 렌더링 하고자 하는 요소를 지정
